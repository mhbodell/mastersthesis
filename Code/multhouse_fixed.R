...
system.time(all_out22010 <- coda.samples(jags_addhouse2010,variable.names = c("x"), n.iter = ninter, thin = 5))
...
system.time(all_out22014 <- coda.samples(jags_all22014,variable.names = c("x"), n.iter = ninter, thin = 5))
