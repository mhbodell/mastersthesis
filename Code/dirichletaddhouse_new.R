...
system.time(jags_ddlmRW2 <- jags.model("diri_diri_lm.bug", data = data, n.chain=3, n.adapt=100000))
ninter=200000
system.time(add_out2 <- coda.samples(jags_ddlmRW2,variable.names = c("x","conc", "sigd"), n.iter = ninter, thin = 100, burnin=10000))
