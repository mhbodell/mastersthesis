...
system.time(jags_mod_M2 <- jags.model("kalman_M2.bug", data = data_M2, n.chains = 3, n.adapt = 100))

system.time(outM2 <- coda.samples(jags_mod_M2,variable.names = c("xM", "M"), n.iter = ninter, n.thin = 1, n.chain=1))
